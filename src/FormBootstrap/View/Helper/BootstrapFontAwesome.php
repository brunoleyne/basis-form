<?php
/**
 * Project: zf2-twb-bundle, File: BootstrapFontAwesome.php
 * @author Michael Schakulat <michael@fetchit.de>
 * @package zf2-twb-bundle
 */

namespace FormBootstrap\View\Helper;

use InvalidArgumentException;
use Zend\Form\View\Helper\AbstractHelper;

/**
 * Class BootstrapFontAwesome
 * @package FormBootstrap\View\Helper
 */
class BootstrapFontAwesome extends AbstractHelper
{
     ...
     * @return string|BootstrapFontAwesome
     */
