...
class TwbBundleDropdownsTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \FormBootstrap\View\Helper\BootstrapDropDown
     */
    ...
    public function testExample()
    {
        $aDropDownOptions = array(
            ...
            'items' => array('Action', 'Another action', 'Something else here', \FormBootstrap\View\Helper\BootstrapDropDown::TYPE_ITEM_DIVIDER, 'Separated link')
        );
    ...
    public function testHeaders()
    {
        $aDropDownOptions = array(
            ...
            'list_attributes' => array('aria-labelledby' => 'dropdownMenu1'),
            'items' => array(
                array('type' => \FormBootstrap\View\Helper\BootstrapDropDown::TYPE_ITEM_HEADER, 'label' => 'Dropdown header'),
                'Action', 'Another action', 'Something else here',
                \FormBootstrap\View\Helper\BootstrapDropDown::TYPE_ITEM_DIVIDER,
                array('type' => \FormBootstrap\View\Helper\BootstrapDropDown::TYPE_ITEM_HEADER, 'label' => 'Dropdown header'),
                'Separated link'
            )
        );
