...
class TwbBundleFormsTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \FormBootstrap\Form\View\Helper\BootstrapForm
     */
    ...
    public function testInlineForm()
    {
        ...
        //Test content
        $this->assertStringEqualsFile($this->expectedPath . 'inline-form.phtml', $this->formHelper->__invoke($oForm, \FormBootstrap\Form\View\Helper\BootstrapForm::LAYOUT_INLINE));
    }
    ...
    public function testFormsControlSizes()
    {
        ...
        //Test content
        $this->assertStringEqualsFile($this->expectedPath . 'forms-control-sizes-column.phtml', $this->formHelper->__invoke($oForm, \FormBootstrap\Form\View\Helper\BootstrapForm::LAYOUT_INLINE));
    }
