...
class TwbBundleFormRowTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \FormBootstrap\Form\View\Helper\BootstrapFormRow
     */
    ...
    public function testRenderAddOnWithInlineLayoutAndDefinedLabelClass()
    {
        ...
        $oElement = new \Zend\Form\Element('test-element', array('twb-layout' => \FormBootstrap\Form\View\Helper\BootstrapForm::LAYOUT_INLINE));
        $oElement
            ->setLabel('test-label')
            ->setLabelAttributes(array('class' => 'test-label-class'));
    ...
    public function testRenderAddOnWithHorizontalLayoutAndDefinedLabelClass()
    {
        ...
        $oElement = new \Zend\Form\Element('test-element', array('twb-layout' => \FormBootstrap\Form\View\Helper\BootstrapForm::LAYOUT_HORIZONTAL));
        $oElement
            ->setLabel('test-label')
            ->setLabelAttributes(array('class' => 'test-label-class'));
    ...
    public function testRendeRadiosWithHorizontalLayout()
    {
        $oElement = new \Zend\Form\Element\Radio('test-radio', array(
            'twb-layout' => \FormBootstrap\Form\View\Helper\BootstrapForm::LAYOUT_HORIZONTAL,
            'label' => 'Test radio',
            'column-size' => 'sm-10',
