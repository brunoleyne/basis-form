...
class TwbBundleFormButtonTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \FormBootstrap\Form\View\Helper\BootstrapFormButton
     */
    ...
    public function testRenderWithAppendGlyphiconPositionOption()
    {
        $this->assertEquals(
            ...
            'label' => 'test',
            'glyphicon' => array('icon' => 'test', 'position' => \FormBootstrap\Form\View\Helper\BootstrapFormButton::ICON_APPEND,)
        )))
        );
    }
