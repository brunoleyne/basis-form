...
class TwbBundleFormErrorsTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Contains an instance of BootstrapFormErrors.
     * @var \FormBootstrap\Form\View\Helper\BootstrapFormErrors
     */
     ...
     * @param \FormBootstrap\Form\View\Helper\BootstrapFormErrors $oFormErrorsHelper
     * @return \TwbBundleTest\Form\View\Helper\TwbBundleFormErrorsTest
     */
    public function setFormErrorsHelper(\FormBootstrap\Form\View\Helper\BootstrapFormErrors $oFormErrorsHelper = null)
    {
     ...
     * @return \FormBootstrap\Form\View\Helper\BootstrapFormErrors
     */
    ...
    public function testInvokeWithoutFormReturnsObject()
    {
        ...
        $this->assertInstanceOf('FormBootstrap\Form\View\Helper\TwbBundleFormErrors', $oHelper());
    }
    ...
    public function testInvokeWithFormCallsRender()
    {
        ...
        $helper = $this->getMock('FormBootstrap\Form\View\Helper\TwbBundleFormErrors', array('render'));
        $helper->expects($this->atLeastOnce())
            ->method('render')
            ->with($this->identicalTo($form), 'There were errors in the form submission', false /* default */)
            ->will($this->returnValue('return value'));

        $this->assertInstanceOf('FormBootstrap\Form\View\Helper\BootstrapFormErrors', $helper());
    ...
    public function testInvokeWithFormNoErrorsReturnsNull()
    {
        ...
        $this->assertInstanceOf('FormBootstrap\Form\View\Helper\TwbBundleFormErrors', $helper());
