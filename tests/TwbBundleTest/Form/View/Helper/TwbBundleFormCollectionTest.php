...
class TwbBundleFormCollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \FormBootstrap\Form\View\Helper\BootstrapFormCollection
     */
    ...
    {
        $oFieldset = new \Zend\Form\Fieldset('inline-fieldset', array('twb-layout' => \FormBootstrap\Form\View\Helper\BootstrapForm::LAYOUT_INLINE));
        ...
        $oCollection = new \Zend\Form\Element\Collection('inline-collection', array(
            'twb-layout' => \FormBootstrap\Form\View\Helper\BootstrapForm::LAYOUT_INLINE
        ));
