...
class TwbBundleFormRadioTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \FormBootstrap\Form\View\Helper\BootstrapFormRadio
     */
    ...
    public function testRenderOptionsWithPrependingLabel()
    {
        ...
        $this->formRadioHelper->setLabelPosition(\FormBootstrap\Form\View\Helper\BootstrapFormRadio::LABEL_PREPEND);
        $this->assertEquals(
